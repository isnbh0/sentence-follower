...
const { findSentenceBoundaries, throttle, debounce } = require('./sentence-highlight.js');
...
describe('Sentence Highlighter', () => {
    ...
    describe('findSentenceBoundaries', () => {
        ...
        test('should handle case 2', () => {
            ...
            const resultText = text.substring(result.start, result.end);
            expect(resultText).toEqual("(At one time, the most-watched episode of television in history was Who Shot J.R.?, a soap opera episode about the murder of an oil baron.");
            expect(result).toEqual({
                start: 165,
        ...
        test('should handle case 3', () => {
            ...
            const resultText = text.substring(result.start, result.end);
            expect(resultText).toEqual("In the 2020s, oil just isn't synonymous with money, and for a similar punch your show would have to be about someone in tech, or just maybe finance.)");
            expect(result).toEqual({
                start: 304,
